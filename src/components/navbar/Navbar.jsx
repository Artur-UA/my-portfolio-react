import './style.css'
import light from '../../img/sun.svg';
import night from '../../img/sun.svg';
            ...
            <div className="container">
                <div className="nav-row">
                    ...
                    <button className="dark-mode-btn">
                        <img src={light} alt="Light" className="dark-mode-btn__icon" />
                        <img src={night} alt="Dark" className="dark-mode-btn__icon" />
                    </button>
